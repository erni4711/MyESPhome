...
if not token:
    print("ERROR: GitHub token not found. Please set git config github.token")
    sys.exit(1)
...
- ESPHome: 2026.4.0
- Board Config: [ESP32-P4-WIFI6-Touch-LCD-7B.yaml](config/boards/ESP32-P4-WIFI6-Touch-LCD-7B.yaml)
...
## Workaround
Currently none available - the component cannot function until initialization order is fixed.
"""
...
data = {
    "title": issue_title,
    "body": issue_body,
    "labels": ["bug", "sd_file_server", "component"]
}
